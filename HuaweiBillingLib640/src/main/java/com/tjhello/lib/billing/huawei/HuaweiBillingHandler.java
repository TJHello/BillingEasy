...
public class HuaweiBillingHandler extends BillingHandler {
    ...
    private List<PurchaseHistoryInfo> toPurchaseHistoryInfo(@Nullable List<String> list){
        if(list==null||list.isEmpty()) return new ArrayList<>();
    ...
    private List<PurchaseInfo> toPurchaseInfo(@Nullable List<String> list){
        if(list==null||list.isEmpty()) return new ArrayList<>();
    ...
    @Nullable
    private PurchaseInfo toPurchaseInfo(@Nullable String data){
